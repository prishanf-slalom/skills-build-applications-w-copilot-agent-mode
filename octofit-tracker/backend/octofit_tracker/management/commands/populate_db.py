...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        Activity.objects.create(user=spiderman, type='Swimming', duration=60, date='2025-11-03')
        Activity.objects.create(user=superman, type='Flying', duration=120, date='2025-11-04')
        ...
        workout1.suggested_for.set([ironman, batman, superman])
        workout2.suggested_for.set([wonderwoman, spiderman, captain])
